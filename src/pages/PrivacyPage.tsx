      ...
      <div className="container-wide py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-muted-foreground">
              Mijn Restaurant respecteert je privacy en zet zich in voor de bescherming van je persoonlijke gegevens. Dit privacybeleid legt uit hoe wij je gegevens verzamelen, gebruiken en beschermen.
            </p>
            ...
            <p className="text-muted-foreground">
              Heb je vragen over dit privacybeleid? Neem contact met ons op via info@mijn-restaurant.nl.
            </p>
          </div>
        </div>
      </div>
