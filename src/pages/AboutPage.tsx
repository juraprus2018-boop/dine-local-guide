...
export default function AboutPage() {
  return (
    <Layout
      title="Over Happio"
      description="Leer meer over Happio - het platform voor het ontdekken van de beste restaurants in Nederland."
    >
      <div className="container-wide py-12">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg mx-auto text-muted-foreground">
            <p>
              Happio is ontstaan uit een simpele frustratie: het vinden van een goed restaurant zou niet zo moeilijk moeten zijn. Wij geloven dat iedereen toegang verdient tot eerlijke, betrouwbare informatie over restaurants in hun buurt.
            </p>
            <p className="mt-4">
              Of je nu op zoek bent naar een romantisch diner, een zakelijke lunch of gewoon een goede pizza, Happio helpt je de perfecte plek te vinden. Met duizenden restaurants, eerlijke reviews en handige filters vind je altijd wat je zoekt.
            </p>
            <p className="mt-4">
